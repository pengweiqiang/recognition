...
Page({
    ...
    getImageInfo() {
        ...
        var imagePath = that.data.picUrl[0];
        console.log("D1  "+imagePath);
    ...
    query.select('#canvasBox')              // 选择我们的canvas节点
      .fields({                             // 需要获取的节点相关信息
        ...
        console.log("D2");
        // ctx.drawImage(imagePath, 0, 0, IMG_REAL_W, IMG_REAL_H);
        console.log("D3");
        ...
        console.log("x="+canvasL+" y= "+canvasT+" width="+canvasW+" height="+canvasH);
